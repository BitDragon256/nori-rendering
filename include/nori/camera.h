...
public:
    ...
    /// Return the parameters for a perspective camera (for visualization purposes)
    /// pos, dir, up, tnear, tfar, fov
    virtual std::tuple<Point3f, Vector3f, Vector3f, float, float, float> getPerspectiveCameraParameters() const { throw std::logic_error("no default implemented"); }
